...
namespace MetadataPublicApiGenerator.Extensions
{
    internal static class PathSearchExtensions
    {
        ...
        public static CompilationModule Resolve(this AssemblyReferenceHandle reference, ICompilation compilation, CompilationModule baseReader, IReadOnlyCollection<string> targetAssemblyDirectories)
        {
            var module = baseReader.MetadataReader.GetAssemblyReference(reference);

            return module.Resolve(compilation, baseReader, targetAssemblyDirectories);
        }
        ...
        public static CompilationModule Resolve(this AssemblyReference reference, ICompilation compilation, CompilationModule baseReader, IReadOnlyCollection<string> targetAssemblyDirectories)
        {
            ...
            return new CompilationModule(fileName, compilation);
        }
