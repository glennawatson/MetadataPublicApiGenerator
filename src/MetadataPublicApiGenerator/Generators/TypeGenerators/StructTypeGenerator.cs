...
namespace MetadataPublicApiGenerator.Generators.TypeGenerators
{
    ...
    internal class StructTypeGenerator : TypeGeneratorBase
    {
        ...
        public StructTypeGenerator(ISet<string> excludeAttributes, ISet<string> excludeMembersAttributes, Func<TypeDefinition, bool> excludeFunc, IGeneratorFactory factory)
        ...
        {
            return SyntaxFactory.StructDeclaration(typeDefinition.GetName(compilation));
        }
    }
}
