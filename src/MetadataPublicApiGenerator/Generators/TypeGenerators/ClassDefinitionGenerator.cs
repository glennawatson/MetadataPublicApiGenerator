...
namespace MetadataPublicApiGenerator.Generators.TypeGenerators
{
    ...
    internal class ClassDefinitionGenerator : TypeGeneratorBase
    {
        ...
        public ClassDefinitionGenerator(ISet<string> excludeAttributes, ISet<string> excludeMembersAttributes, Func<TypeDefinition, bool> excludeFunc, IGeneratorFactory factory)
        ...
        {
            return SyntaxFactory.ClassDeclaration(typeDefinition.GetName(compilation));
        }
    }
}
