...
namespace LightweightMetadata.TypeWrappers
{
    ...
    {
        private static readonly Dictionary<(ModuleReferenceHandle handle, CompilationModule module), ModuleReferenceWrapper> _registerTypes = new Dictionary<(ModuleReferenceHandle handle, CompilationModule module), ModuleReferenceWrapper>();
